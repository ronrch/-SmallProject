...
WebUI.setText(findTestObject('Checkout/Txt_midtrans_plow'), '20000')
...
WebUI.setText(findTestObject('Checkout/Txt_email'), 'ronngmail.com')

WebUI.setText(findTestObject('Checkout/Txt_phone'), 'aaaaaa&')

WebUI.setText(findTestObject('Checkout/Txt_city'), 'Bandung')

WebUI.setText(findTestObject('Checkout/Txt_address'), 'Batununggal')

WebUI.setText(findTestObject('Checkout/Txt_postal_code'), 'asdasd')
